...
// TODO: feedbackCtrl --|-- 
.controller("feedbackCtrl", function($scope,$rootScope,$state,$location,$ionicScrollDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$ionicLoading,$ionicPopup,$ionicPopover,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64){
	
	$rootScope.headerExists = true;
	$rootScope.page_id = "feedback" ;
	$rootScope.last_edit = "menu" ;
	// TODO: feedbackCtrl --|-- $scope.scrollTop
	$scope.scrollTop = function(){
		$ionicScrollDelegate.$getByHandle("top").scrollTop();
	};
	// TODO: feedbackCtrl --|-- $scope.openURL
	// open external browser 
	$scope.openURL = function($url){
		window.open($url,"_system","location=yes");
	};
	// TODO: feedbackCtrl --|-- $scope.openAppBrowser
	// open AppBrowser
	$scope.openAppBrowser = function($url){
		window.open($url,"_blank","hardwareback=Done");
	};
	// TODO: feedbackCtrl --|-- $scope.openWebView
	// open WebView
	$scope.openWebView = function($url){
		window.open($url,"_self");
	};
	
	// TODO: feedbackCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	// TODO: feedbackCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
			...
			console.log("error: page feedback => custom controller");
			console.log(e);
		}
	}
	$scope.rating = {};
...
// TODO: form_feedbackCtrl --|-- 
.controller("form_feedbackCtrl", function($scope,$rootScope,$state,$location,$ionicScrollDelegate,$http,$httpParamSerializer,$stateParams,$timeout,$ionicLoading,$ionicPopup,$ionicPopover,$ionicSlideBoxDelegate,$ionicHistory,ionicMaterialInk,ionicMaterialMotion,$window,$ionicModal,base64){
	
	$rootScope.headerExists = true;
	$rootScope.page_id = "form_feedback" ;
	$rootScope.last_edit = "forms" ;
	// TODO: form_feedbackCtrl --|-- $scope.scrollTop
	$scope.scrollTop = function(){
		$ionicScrollDelegate.$getByHandle("top").scrollTop();
	};
	// TODO: form_feedbackCtrl --|-- $scope.openURL
	// open external browser 
	$scope.openURL = function($url){
		window.open($url,"_system","location=yes");
	};
	// TODO: form_feedbackCtrl --|-- $scope.openAppBrowser
	// open AppBrowser
	$scope.openAppBrowser = function($url){
		window.open($url,"_blank","hardwareback=Done");
	};
	// TODO: form_feedbackCtrl --|-- $scope.openWebView
	// open WebView
	$scope.openWebView = function($url){
		window.open($url,"_self");
	};
	
	// TODO: form_feedbackCtrl --|-- $scope.redirect
	// redirect
	$scope.redirect = function($url){
		$window.location.href = $url;
	};
	...
	//feedback
	$scope.form_feedback= {};
	// TODO: form_feedbackCtrl --|-- $scope.submitFeedback
	$scope.submitFeedback = function(){
		...
		$http({
				method:"POST",
				url: "http://gumig.com/wp-json/telugu_jokes/v2/app_feedback_submit",
				data: $httpParamSerializer($scope.form_feedback),  // pass in data as strings
			...
			.then(function(response) {
				...
				$timeout(function() {
					...
					var alertPopup = $ionicPopup.alert({
						...
						// clear input
						$scope.form_feedback.your_name = "";
						$scope.form_feedback.any_comments = "";
					}
			}, 500);
		});
	};
	...
	// TODO: form_feedbackCtrl --|-- controller_by_user
	// controller by user 
	function controller_by_user(){
		try {
			...
			console.log("error: page form_feedback => custom controller");
			console.log(e);
		}
	}
	$scope.rating = {};
